...
public class Ibatis3SessionFactory
        implements FactoryBean, InitializingBean
{
    ...
    public Class getObjectType() {
        return this.sqlSessionFactory != null ?
                this.sqlSessionFactory.getClass() : SqlSessionFactory.class;
    }
    ...
    public void afterPropertiesSet() throws Exception {
        this.sqlSessionFactory = buildSqlSessionFactory(this.configLocation);
    }
    ...
    protected SqlSessionFactory buildSqlSessionFactory(String configLocation) throws IOException {
        ...
        Environment environment = new Environment(this.environmentId,
